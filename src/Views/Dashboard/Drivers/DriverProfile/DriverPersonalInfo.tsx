...
const DriverPersonalInfo = () => {
  ...
  return (
    <div className="flex gap-20 max-md:flex-col max-md:gap-5 w-full bg-background shadow-[0px_0px_5px_2px_hsl(var(--foreground)/0.1)] rounded-2xl p-6">
          ...
          <RFlex className="flex-col gap-3">
            ...
            <RFlex className="flex-col gap-2 text-[12px]">
              ...
              >
                ...
                <span className="flex gap-1 items-center">{driver.degree}</span>
              </a>
            </RFlex>
          </RFlex>
        </RFlex>
